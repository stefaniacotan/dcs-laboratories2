package lab5.Distributed_OER_TPN_Lab;
...
import lab5.Components.PetriNetWindow;
...
public class Exp_Part1 {
	...
	public static PetriNet PN4() {
		// ----------------------- SubPetri ------------------------------------
		PetriNet mpn2 = new PetriNet();
		mpn2.PetriNetName = "PN4";
		mpn2.NetworkPort = 0;

		DataFloat constantVal4 = new DataFloat();
		constantVal4.SetName("constantVal4");
		constantVal4.SetValue(0.2f);
		mpn2.ConstantPlaceList.add(constantVal4);
		
		DataFloat constantVal5 = new DataFloat();
		constantVal5.SetName("constantVal5");
		constantVal5.SetValue(4.0f);
		mpn2.ConstantPlaceList.add(constantVal5);

		DataFloat p41 = new DataFloat();
		p41.SetName("p41");
		mpn2.PlaceList.add(p41);

		DataFloat p42 = new DataFloat();
		p42.SetName("p42");
		mpn2.PlaceList.add(p42);

		DataFloat p43 = new DataFloat();
		p43.SetName("p43");
		mpn2.PlaceList.add(p43);

		DataTransfer p44 = new DataTransfer();
		p44.SetName("p44");
		p44.Value = new TransferOperation("localhost", "1080", "p6");
		mpn2.PlaceList.add(p44);
		
		// T41 ------------------------------------------------
		PetriTransition t41 = new PetriTransition(mpn2);
		...
		lstInput4.add("p41");
		lstInput4.add("constantVal4");
		
		grdT41.Activations.add(new Activation(t41, lstInput4, TransitionOperation.Add, "p42"));

		t41.GuardMappingList.add(grdT41);
		t41.Delay = 1;
		mpn2.Transitions.add(t41);

		// T42 ------------------------------------------------
		PetriTransition t42 = new PetriTransition(mpn2);
		...
		t42.Delay = 0;
		mpn2.Transitions.add(t42);
		// T44 ------------------------------------------------
		PetriTransition t44 = new PetriTransition(mpn2);
		t44.TransitionName = "t44";
		t44.InputPlaceName.add("p43");

		Condition t44Ct1 = new Condition(t44, "p43", TransitionCondition.NotNull);
		Condition t44Ct2 = new Condition(t44, "p43", TransitionCondition.MoreThan, "constantVal5");
		...
		t44.Delay = 0;
		mpn2.Transitions.add(t44);
		
		// T43 ------------------------------------------------
		PetriTransition t43 = new PetriTransition(mpn2);
	...
	public static void main(String[] args) {
		...
		DataFloat constantVal6 = new DataFloat();
		constantVal6.SetName("constantVal6");
		constantVal6.SetValue(2.0f);
		pn.ConstantPlaceList.add(constantVal6);
		...
		Condition T1Ct2 = new Condition(t1, "p2", TransitionCondition.LessThan, "constantVal6");
		...
		Condition T1Ct4 = new Condition(t1, "p2", TransitionCondition.MoreThanOrEqual, "constantVal6");
		T1Ct3.SetNextCondition(LogicConnector.AND, T1Ct4);
		
		GuardMapping grdT1_2 = new GuardMapping();
		grdT1_2.condition = T1Ct3;
		
		grdT1_2.Activations.add(new Activation(t1, "PN4", TransitionOperation.Copy, "p3"));
		grdT1_2.Activations.add(new Activation(t1, "p1", TransitionOperation.Move, "p4"));
		grdT1_2.Activations.add(new Activation(t1, "p2", TransitionOperation.Move, "p3-p41"));
