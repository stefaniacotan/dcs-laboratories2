...
// specify constants and period
        ...
        FirstOrderSystemThreaded plant = new
                FirstOrderSystemThreaded(0.5, 0.65, 0.23, 0.3, period);
...
// specify the exit interval of the system
        ...
        FuzzyDriver userCommandInDriver =
                FuzzyDriver.createDriverFromMinMax(-0.7, +0.6);
...
//        net.addArcFromPlaceToTransition(p7Mem, t3, 0.1);
//        net.addArcFromPlaceToTransition(p5, t3, 0.3);
